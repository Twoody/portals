...
var FlavorForm = function (_React$Component) {
	...
	function FlavorForm(props) {
		...
		_this.optionsArr = [{ title: 'Grapefruit', value: 'grapefruit' }, { title: 'Lime', value: 'lime' }, { title: 'Coconut', value: 'coconut' }, { title: 'Mango', value: 'mango' }];
		_this.optionsJSX = _this.optionsArr.map(function (optionItem) {
...
ReactDOM.render(React.createElement(FlavorForm, null), document.getElementById('forms_example'));