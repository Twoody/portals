...
var Ball = function () {
	...
	_createClass(Ball, [{
		...
		value: function handleRectangleInteractions(rectangle, screenWidth, screenHeight) {
			...
			if (this.nextY - this.radius <= rectangle.yBottom && this.nextY + this.radius >= rectangle.yBottom && this.isGoingUp) {
			...
			if (this.nextX - this.radius >= rectangle.xRight || this.nextX + this.radius <= rectangle.xLeft) {
			...
			if (this.nextX + this.radius >= rectangle.xLeft && this.nextX - this.radius <= rectangle.xLeft) {
				//If ball right is right of the left side
				// and ball left is left of the left side
				ballRightOverLapsLeft = true;
			}
			if (this.nextX - this.radius <= rectangle.xRight && this.nextX + this.radius >= rectangle.xRight) {
