...
function get_paths($ROOT=Null){
	...
	return Array(
		...
		'DB_USERS'							=> $ROOT."/../dbs/users.db",
		'DB_INVENTORY'						=> $ROOT."/../dbs/inventory.db",
		'DB_RESOURCES'						=> $ROOT."/../dbs/resources.db",
		...
		'GET_BLOGS'							=> $ROOT.'/u/actions/get_blogs/index.php',
		...
		'LIBPATH_DB_PAGES'				=> $ROOT.'/src/utils/db_pages.php',
		...
		"LOCAL_JS_REACT"					=> $ROOT.'/resources/js/offline/react.development.js',		//TODO: Minify
		"LOCAL_JS_REACT_DOM"				=> $ROOT.'/resources/js/offline/react-dom.development.js',	//TODO: Minify
		"LOCAL_JS_BABEL"					=> $ROOT.'/resources/js/offline/babel.min.js',
		...
		'REACT_JS_PATH'					=> $ROOT.'/resources/js/react.php',
		'ROOT'								=> $ROOT,
